...
<head>
    ...
    <title>Portfolio Naila Firanda</title>
    <style>
        body {
...
<body>
   <div class="container">
        <div class="header">
            <img src="https://i.pinimg.com/originals/86/77/39/8677392ad3541a697e252b6d82bf3e22.jpg" alt="Foto Profil">
            <h1>Naila Firanda</h1>
            <p>Kota Serang , Banten | Firandanaila@gmail.com | 0859-4596-0594 </p>
        </div>
        <div class="content">
            <head>
    <meta charset="UTF-8">
...
<body>
    ...
    <p></p>
            ...
            <body>
                <ul>
                    <li>Menjadi kasir yang ramah dan amanah</li>
                </ul>
            </body>
            ...
            <body>
                <ul>
                    <li>Menjadi ketua kelompok yang bijaksana</li>
                    <li>Menjadi ketua kelompok yang sangat sabar dan tidak pernah marah-marah(bohong)</li>
                </ul>
            </body>
		<h4>BENDAHARA</h4>
            <html lang="en">
            ...
            <body>
                <ul>
                    <li>Menjadi bendahara yang amanah</li>
                    <li>Tidak pernah marah-marah saat menagih</li>
...
<body>
    ...
    <a href="https://www.instagram.com/nlfrrnd?igsh=MWdqZG4WNXdiczJ0Ng" class="button">
